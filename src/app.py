...
# Add special handling for first run to show a welcome message
...
def main():
    ...
    if st.session_state.first_run:
        st.info("Welcome to Matchwise AI! This application is now using real data from your datasets.")
